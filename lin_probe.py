...
from dejavu_utils.utils import SSL_Transform, stopwatch, SSLNetwork, TrainTransform

def parse_args():
    parser = argparse.ArgumentParser("linear probe args")

    parser.add_argument("--local", default = 0, type=int, help="whether to run locally")
