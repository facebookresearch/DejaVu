...
def parse_args():
    ...
    parser.add_argument("--imgnet_dir", default='/datasets01/imagenet_full_size/061417/train/', 
                        type=str, help="imgnet train folder")
    parser.add_argument("--bbox_dir", default='/private/home/caseymeehan/imgnet_bboxes', 
                        type=str, help="bounding box annotation folder")
    parser.add_argument("--save_dir", default='/private/home/caseymeehan/SSL_reconstruction/imgnet_partition', 
                        type=str, help="bounding box annotation folder")             
...
def main(args): 
    ...
    for CLS in SSL_train_classes: 
        ...
        bbox_cls_dir = os.path.join(args.bbox_dir, CLS, 'Annotation', CLS)
