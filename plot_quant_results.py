...
def parse_args(): 
    ...
    parser.add_argument("--attk_folder_path", type=str, default='',
            help="folder attacks path")
    parser.add_argument("--lin_probe_folder_path", type=str, default='',
            help="folder linear prob path")
...
def main(args): 
    ...
    traces = pu.get_attack_data(
                ...
                topks = [1,5],
                attk_folder_path = args.attk_folder_path,
    )
    ...
    if args.plot_lin_probe == 1:
        ...
        _ = pu.get_linprobe_plots_epochs(
            ...
            epochs = [50, 100, 250, 500, 750, 1000],
            pth = savepth, 
            lin_probe_folder_path = args.lin_probe_folder_path
        )
