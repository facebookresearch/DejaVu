#attack supervised using backbone at 50, 100, 250, 500, 750, and 1000 epochs for 
...
do 
  ...
  do 
	python3  label_inference_attack.py \
		...
		--loss "supervised" \
		--use_volta32 \
		--output_dir "/checkpoint/caseymeehan/experiments/ssl_sweep/supervised/attack_sweeps_backbone/NN_attk_supervised_${d}pc_${e}ep" \
