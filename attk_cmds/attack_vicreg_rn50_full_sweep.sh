#attack vicreg_rn50 at 50, 100, 250, 500, 750, and 1000 epochs for 
...
do 
  ...
  do 
	python3  label_inference_attack.py \
		...
		--loss "vicreg" \
		--use_volta32 \
		--output_dir "/checkpoint/caseymeehan/experiments/ssl_sweep/vicreg_rn50/attack_sweeps/NN_attk_vicreg_rn50_${d}pc_${e}ep" \
		--model_A_pth "/checkpoint/caseymeehan/experiments/ssl_sweep/vicreg_rn50/vicreg_dssweep_${d}pc_A/model_ep${e}.pth" \
		--model_B_pth "/checkpoint/caseymeehan/experiments/ssl_sweep/vicreg_rn50/vicreg_dssweep_${d}pc_B/model_ep${e}.pth" \
