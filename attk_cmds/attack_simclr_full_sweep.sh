#attack simclr at 50, 100, 250, 500, 750, and 1000 epochs for 
...
do 
  ...
  do 
	python3  label_inference_attack.py \
		...
		--loss "simclr" \
		--use_volta32 \
		--output_dir "/checkpoint/caseymeehan/experiments/ssl_sweep/simclr/attack_sweeps/NN_attk_simclr_${d}pc_${e}ep" \
