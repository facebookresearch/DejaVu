...
python3 run_with_submitit.py \
	...
	--batch_size 8 \
	--out_dir  '/checkpoint/caseymeehan/experiments/rcdm_2/supervised/rcdm_supervised_1000ep_300pc_A' \
	--ssl_model_pth '/checkpoint/caseymeehan/experiments/ssl_sweep/supervised/supervised_dssweep_300pc_A/model_ep1000.pth' \
