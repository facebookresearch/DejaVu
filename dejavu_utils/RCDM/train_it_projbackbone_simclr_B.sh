...
python3 run_with_submitit.py \
	...
	--batch_size 8 \
	--out_dir  '/checkpoint/caseymeehan/experiments/rcdm_2/simclr/rcdm_simclr_1000ep_300pc_B' \
	--ssl_model_pth '/checkpoint/caseymeehan/experiments/ssl_sweep/simclr/simclr_dssweep_300pc_B/model_ep1000.pth' \
