...
python3 run_with_submitit.py \
	...
	--batch_size 8 \
	--out_dir  '/checkpoint/caseymeehan/experiments/rcdm_2/vicreg/rcdm_vicreg_1000ep_300pc_B' \
	--ssl_model_pth '/checkpoint/caseymeehan/experiments/ssl_sweep/vicreg/vicreg_dssweep_300pc_B/model_ep1000.pth' \
