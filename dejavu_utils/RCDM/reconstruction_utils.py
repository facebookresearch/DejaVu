...
from .scripts.image_sample import create_argparser
...
def get_attack_data(model, dataset, epoch, k_neighb):
    #get attack data
...
def gen_samples(
    ...
    n_samples = 4,
    attk_set = 'A',
    imgnet_dir = '/datasets01/imagenet_full_size/061417/train',
    bbox_dir = '/private/home/caseymeehan/imgnet_bboxes', 
    just_neighbs = False, 
    ...
    with open("/private/home/caseymeehan/scale_code/imgnet_classes.json") as f:
...
def tile_reconstructions(model, im_dict, examp_subset = []): 
    ...
    save_pth = f'/checkpoint/caseymeehan/experiments/rcdm/{model}/reconstructions/'
